...
{/* Hero section */}
    <section>
        <div className="text-center md:text-center sm:text-center pt-10">
           <h1 className="text-[48px] font-bold">Step into <span style={{ color: '#F68347' }}>Style</span>  & Discover <span style={{ color: '#F68347' }}>Fashion</span> <br/> Freedom Online with <br />
           <span style={{ color: '#F68347' }}>Every Click</span></h1>
        </div>
...
<section className='pt-[48px] mx-[78px]'>
         <div className='flex flex-row space-x-[886px] px-[70px]'>
                 <h1 className='text-[32px] font-bold'>BEST <span style={{ color: '#F68347' }}>SELLERS</span></h1>
    ...
    <section className='pt-[46px] mx-[78px] '>
        <div className='px-[70px]'>
            <h1 className='font-bold text-[32px] text-right'>SHOP BY <span style={{ color: '#F68347' }}>CATEGORY</span></h1>
        </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-[10rem] h-full">
    <div className="col-span-2 sm:col-span-1 md:col-span-2 bg-gray-50 h-auto w-[536px] md:h-full flex flex-col">
      ...
      >
        ...
        <h4 className="text-[16px] font-medium text-white absolute top-10 left-0 p-4 ">SHOP NOW</h4>
      </a>
    </div>
    ...
    <div className="hero min-h-screen relative bg-cover bg-center" style={{backgroundImage: `url(${callToAction})`}}>
    <div className="hero-content text-center relative z-10">
    <div className="">
      <h1 className="text-[80px] font-bold text-white">So? What are you <span style={{ color: '#F68347' }}>waiting for?</span></h1>
      <p className="py-6 text-white">Don't hesitate! Dive into Fashion Threads now and pick out your next favorite outfit. <br />
The latest trends are just a click away!.</p>
      <div className="flex justify-center pt-5 space-x-3">
          <button className="btn text-white w-[228px] h-[64px]" style={{ backgroundColor: "#F68347" }}>SHOP NOW</button>
      </div>
    </div>
    </div>
    </div>
